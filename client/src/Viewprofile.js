...
const Viewprofile = () => {
    ...
    <div className=' text-center text-uppercase border border-warning w-50 p-3 mx-auto'>
    <img src={post.image} className="rounded-circle"></img> <br/>
    <Link to={`/edit-user/vprofile/${id}`}><Button><EditIcon/></Button></Link>
